let oUl = document.querySelector("#wrap ul.list");
...
function Helix(){
    ...
    [...aLi].forEach((node,index)=>{
        ...
        node.style.transform = `rotateY(${index*rY}deg) translateZ(800px) translateY(${tY}px)`;
    });
}
...
function Sphere() {
    ...
    [...aLi].forEach((node,index)=>{
        ...
        node.style.transform = ` rotateY(${rY}deg) rotateX(${rX}deg) translateZ(800px)`;
    });
}
